...
import { classSet } from 'base/utils';
import { generateUniqueId } from 'base/inputUtils';
import { keyCodes } from 'base/utilsPrivate';
...
export default class cAccordionSection extends LightningElement {
    ...
    shouldEmitRegisterEvent = false;

    connectedCallback() {
        this.setAttribute('role', 'listitem');
        this.classList.add('slds-accordion__list-item');
        // Removed until this issue is closed: https://github.com/salesforce/lwc/issues/1452
