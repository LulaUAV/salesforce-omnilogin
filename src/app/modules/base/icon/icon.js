...
import { classListMutation, normalizeString, isIE11 } from 'base/utilsPrivate';
import { computeSldsClass, getCategory, isValidName } from 'base/iconUtils';
...
export default class cIcon extends LightningElement {
    ...
    set iconName(value) {
        ...
        if (isValidName(value)) {
            ...
            console.warn(`<base-icon> Invalid icon name ${value}`); // eslint-disable-line no-console
