...
import { classListMutation, normalizeString } from 'base/utilsPrivate';
import { computeSldsClass } from 'base/iconUtils';
...
export default class cAvatar extends LightningElement {
    ...
    handleImageError(event) {
        ...
        console.warn(
            `<base-avatar> Image with src="${event.target.src}" failed to load.`
        );
